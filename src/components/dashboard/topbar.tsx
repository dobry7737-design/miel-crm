  ...
  return (
    <header className="relative flex items-center gap-3 border-b border-slate-200/80 bg-white/60 px-4 py-4 backdrop-blur-xl sm:px-6">
      ...
      <div className="ml-auto flex items-center gap-2">
        ...
        <button className="flex h-10 items-center gap-2 rounded-lg bg-blue-500 px-3 text-sm font-semibold text-white shadow-sm shadow-blue-500/30 transition hover:bg-blue-600 active:scale-[0.98] sm:px-4">
