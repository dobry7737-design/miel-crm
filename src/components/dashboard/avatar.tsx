...
const BRANCH_COLORS: Record<string, string> = {
  ...
  Santé: 'bg-emerald-100 text-emerald-600',
  Habitation: 'bg-amber-100 text-amber-600',
  Voyage: 'bg-violet-100 text-violet-600',
  Vie: 'bg-rose-100 text-rose-600',
}
  ...
  return (
    <span
      className={cn(
        ...
        BRANCH_COLORS[branch] || 'bg-slate-100 text-slate-600'
      )}
    >
