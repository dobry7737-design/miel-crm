...
async function main() {
  ...
  const settings: Record<string, string> = {
    ...
    rccm: 'MA.BKO.2024.B.',
    slogan: 'Votre confiance, notre engagement',
    email: 'contact@aamassistances.com',
    telephone: '+223 20 29 40 40 / 76 37 37 37',
    telephone1: '+223 20 29 40 40',
    telephone2: '+223 76 37 37 37',
    site: 'aamassistances.com',
    adresse: 'Hamdallaye ACI 2000, Avenue Tombouctou, Rue 430, Bamako, Mali',
    langue: 'fr',
    anneesExperience: '15',
    partenaires: '13',
    tauxSatisfaction: '98',
