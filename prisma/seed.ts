...
async function main() {
  ...
  const produitsData = [
    ...
    },
    {
      ...
      branche: 'Voyage',
      tarifsJson: JSON.stringify({ basePrime: 45000 }),
      garanties: 'Frais médicaux,Annulation,Bagages,Assistance 24/7',
    },
    {
      compagnieId: nsia.id,
      nom: 'Voyage Afrique',
      branche: 'Voyage',
      tarifsJson: JSON.stringify({ basePrime: 28000 }),
      garanties: 'Frais médicaux,Assistance 24/7',
    },
    {
      compagnieId: afg.id,
      nom: 'Vie Épargne',
